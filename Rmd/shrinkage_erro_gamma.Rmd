...
sample_burnin_thinning <- sample$theta[seq(5000, 30000, 10),]
...
$$
\mathbb{E}(e_{ij}) = \frac{\beta}{\lambda} = \frac{49}{5} \approx 9.8 \hspace{2cm} \text{e} \hspace{2cm} \mathbb{V}(e_{ij}) = \frac{\beta}{\lambda^2} = \frac{49}{5^2} = 1.96
$$
assim, obtendo
...
# plot da amostra
plot(x=(1:M)/M, y=NULL, type='n', xlim=c(0,1), ylim=c(-2, 39), ylab='', main = 'Amostra')
