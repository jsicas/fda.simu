...
Além disso, considere a amostra comporta por $L = 2$ funções componentes, sendo elas a Bumps e a Doppler, medidas em $M = 16$ pontos diferentes, e $I = 4$ observaçãoes. Então, nossa amotra consiste em $\{(t_m, A_i(t_m)), \; i=1,\dots,4 \;,\; m=1,\dots,16\}$, com erro gamma. Ademais, será denotado no código $\boldsymbol f = \boldsymbol\alpha \boldsymbol y$. Então, gerando uma amostra temos:
