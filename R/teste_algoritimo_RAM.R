...
# a <- c(4, 5, 3, 4, 2, 4, 4, 2)               # W(d - theta) = a >= 0
...
# L <- 5000              # quantidade de iterações
...
# alpha <- 0.8  # parâmetro de mistura da priori spike and slab
# tau <- 2
# beta <- 10; lambda <- 40  # parâmetro gamma
# f <- f_test(n)$bumps
